...
<?php } ?>
	...
	<link href="/stylesheets/april_v2.css" rel="stylesheet" type="text/css" />
...
<body onload="onLoadHandler()" onunload="onUnloadHandler()">
	<div id="Header">
		<h1 id="HeaderLogo"><a href="/"><img src="/images/version2/frame/april_logo.png" alt="The Yorker" /></a></h1>
		<div id="HeaderItems">
			<div id="HeaderMenu">
				<?php
...
$menu = array(
	...
	array('election', '/election10', array('last')),
);
