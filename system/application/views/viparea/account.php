...
if($maintainer['maintained']){
	if($maintainer['student']){ ?>
		...
		<p>
			<strong>Account Maintainer:</strong> <?php echo(xml_escape($maintainer['maintainer_firstname'] . ' ' . $maintainer['maintainer_surname'])); ?><br />
			<strong>Maintainer's Email:</strong> <?php echo(xml_escape($maintainer['maintainer_student_email'])); ?><br />
		</p>
	<?php }else{ ?>
		<p>
		...
		<p>
			<strong>Account Maintainer:</strong> <?php echo(xml_escape($maintainer['maintainer_name'])); ?><br />
			<strong>Maintainer's Email:</strong> <?php echo(xml_escape($maintainer['maintainer_email'])); ?><br />
		</p>
	<?php
	}
}else{ ?>
