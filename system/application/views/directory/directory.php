	...
	<div class='RightToolbar'>
		...
		<div style='padding: 10px 5px 10px 5px; font-size:small;'>
			<form name='search_directory' action='' method='POST' class='form'>
				...
				<div style='padding: 5px; width: 100%;'><input id="searchText" width='300' name="search" onKeyUp="searchPage('searchText','Letter','filterCheck');"><div id="loadingdiv" style="display: none;"> <image src="/images/prototype/prefs/loading.gif" width="16" height="16" />  </div> </div>
				e.g. football
