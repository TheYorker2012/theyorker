...
<form name='edit_card' method='post' action='<?php echo vip_url('directory/cards/'.$business_card['id'].'/edit'); ?>' class='form'>
	<fieldset>
		...
		<input name='card_revertbutton' type='button' onClick="parent.location='<?php echo vip_url('directory/cards/'.$business_card['id'].'/edit'); ?>'"value='Undo Changes' class='button' />
