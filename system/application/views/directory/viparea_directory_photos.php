...
<div>
	<label for="title1">Photo Title:</label><input type="text" name="title1" size="30" /><br />
	<label for="userfile1">Photo File:</label><input type="file" name="userfile1" size="30" /><br />
</div>
