...
foreach ($photos as $thumbnail) { ?>
	<div class="gallery_detail_view" style="<?php if ($flip) echo('clear:left'); $flip = !$flip; ?>">
		...
		<div>
			<span class="orange">Title: </span><?php echo(xml_escape($thumbnail->photo_title)); ?><br />
			<span class="orange">Date: </span><?php echo($thumbnail->photo_timestamp); ?><br />
			<span class="orange">Photographer: </span><?php echo(xml_escape(fullname($thumbnail->photo_author_user_entity_id))); ?>
		</div>
	</div>
<?php } ?>