	<div class="BlueBox">
		<div style="float:right;margin:0.2em 0.5em;text-align:right">
			<img src="<?php echo(($business_card_image_href != '') ? $business_card_image_href : 'http://www.theyorker.co.uk/images/prototype/directory/members/no_image.png'); ?>" alt="<?php echo(xml_escape($business_card_name)); ?>" title="<?php echo(xml_escape($business_card_name)); ?>" />
		</div>
		...
		<div>
			<?php if ($business_card_course !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/script.png" alt="" title="Course" />
				<b>Course:</b>
				<?php echo(xml_escape($business_card_course)); ?>
				<br />
			<?php } ?>
			<?php if ($business_card_email !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/email.png" alt="" title="E-Mail Address" />
				<b>E-Mail:</b>
				<?php echo(xml_escape($business_card_email)); ?>
				<br />
			<?php } ?>
			<?php if ($business_card_phone_internal !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/phone.png" alt="" title="Internal Phone" />
				<b>Phone (Int):</b>
				<?php echo(xml_escape($business_card_phone_internal)); ?>
				<br />
			<?php } ?>
			<?php if ($business_card_phone_external !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/phone.png" alt="" title="External Phone" />
				<b>Phone (Ext):</b>
				<?php echo(xml_escape($business_card_phone_external)); ?>
				<br />
			<?php } ?>
			<?php if ($business_card_mobile !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/phone.png" alt="" title="Mobile" />
				<b>Mobile:</b>
				<?php echo(xml_escape($business_card_mobile)); ?>
				<br />
			<?php } ?>
			<?php if ($business_card_postal_address !== NULL) { ?>
				<img src="http://www.theyorker.co.uk/images/icons/map.png" alt="" title="Address" />
				<b>Address:</b>
