<div id="RightColumn">
	...
	<div class="Entry">
		<ul>
			...
			{
			?>
				<li><a href="/office/pr/suggestions/">Back To Suggestions</a></li>
			<?php
			}
			else if ($status == 'unassigned')
			{
			?>
				<li><a href="/office/pr/unnassigned/">Back To Unassigned</a></li>
			<?php
			}
			else if ($status == 'pending')
			{
			?>
				<li><a href="/office/pr/pending/">Back To Pending</a></li>
			<?php
			}
			?>
		</ul>
