...
-->
	<?php 
		...
		$link = 'http://graduates.teachfirst.org.uk';
		$alt = 'Teach First';
		echo '<a href="' . $link . '" title="' . $alt . '" />';
		echo '<img src="' . $img . '" style="width: 320px; height: 70px;" alt="' . $alt . '" />';
		echo '</a>';	
	...
	<?php 
		...
		/*
		echo '<a href="' . $advert['url'] . '" title="' . $advert['alt'] . '" />';
		echo '<img src="http://theyorker.co.uk/image/advert/' . $advert['image_id'] . '" style="width:320px; height: 70px;" />';
		echo '</a>';
		*/	
	?>
