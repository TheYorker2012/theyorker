	...
	<div class="HalfBox">
		...
		<input type="radio" value="1" name="vote"> SWIMMING POOL<br>
		<input type="radio" value="2" name="vote"> ANTI-ARMS<br>
		<input type="radio" value="3" name="vote"> KILL ALL ANTS<br>
		<input type="radio" value="4" name="vote"> BUDDHIST CAMPUS<br>
	...
	<div class="subsubtitle">CHOISE DEADLINE FOR STUDENTS IS <?php echo $subdata['DeadLine']; ?></div><br>
