	...
	<div class="Container">
		...
		<div class="HalfBox">
			...
			<div style="padding-top:10px;">
				...
				<div style="float: left;font-size: 12px;">Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text. Descriptive Text.</div>
			</div>
			<div style="padding-top:10px;">
				<div style="float: left;font-weight: bold;">John Doe</div><div style="float: right;font-weight: bold;">Mon Nov 6:05</div><br>
				<div style="float: left;font-weight: bold;color: FF6A00;">No Place For Swimmers</div><br>
