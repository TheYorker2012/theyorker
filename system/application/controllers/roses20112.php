...
class Roses20112 extends Controller
{
	...
	function index()
	{
		...
		//Main article 
		$data['liveblog'] = $this->home_hack_model->getArticlesByTags(array('Roses 2011', 'liveblog'), 1);
		$data['others'] = $this->home_hack_model->getArticlesByTags(array('Roses 2011'), 15);
		...
		$sql = 'SELECT * FROM roses_scores2011 ORDER BY event_time ASC';
		...
		$this->main_frame->SetContentSimple('homepages/roses2011', $data);
