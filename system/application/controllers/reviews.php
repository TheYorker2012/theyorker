...
class Reviews extends Controller {
	...
	function food()
	{
		...
		$type_array['link'] = array('reviews/table/1/1','reviews/table/1/2','reviews/table/1/3','reviews/table/1/4','reviews/table/1/5','reviews/table/1/6','reviews/table/1/0');
		$data['type_array'] = $type_array;

		$price_array['name'] = array('Dirt Cheap','Super Cheap','Kinda Cheap','Meh','Mega Expensive','All Prices');
		$price_array['link'] = array('reviews/table/1/1','reviews/table/1/2','reviews/table/1/3','reviews/table/1/4','reviews/table/1/5','reviews/table/1/0');
	...
	function drink()
	{
		...
		$price_array['name'] = array('Dirt Cheap','Super Cheap','Kinda Cheap','Meh','Mega Expensive','All Prices');
		$price_array['link'] = array('reviews/table/2/1','reviews/table/2/2','reviews/table/2/3','reviews/table/2/4','reviews/table/2/5','reviews/table/2/0');
		$data['price_array'] = $price_array;
	...
	function culture()
	{
		...
		$location_array['link'] = array('reviews/table/3/1','reviews/table/3/2','reviews/table/3/3','reviews/table/3/4','reviews/table/3/5','reviews/table/3/0');
		$data['location_array'] = $location_array;

		$price_array['name'] = array('Dirt Cheap','Super Cheap','Kinda Cheap','Meh','Mega Expensive','All Prices');
		$price_array['link'] = array('reviews/table/3/1','reviews/table/3/2','reviews/table/3/3','reviews/table/3/4','reviews/table/3/5','reviews/table/3/0');
		$data['price_array'] = $price_array;
	...
	function context($organisation_directory_entry_name,$content_type_codename)
	{
		$this->pages_model->SetPageCode('review_context_'.$content_type_codename);
		...
		// Set up the public frame
		$data['comments'] = $this->Review_model->GetComments($organisation_directory_entry_name, $content_type_codename); //User comments
		$this->frame_public->SetTitleParameters(array('organisation' => 'organisation name from db'));
	...
	{
		$comment['comment_organisation_entity_id'] = $_POST['comment_organisation_entity_id'];
		$comment['comment_content_type_id'] = $_POST['comment_content_type_id'];
