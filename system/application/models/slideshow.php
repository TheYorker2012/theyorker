...
class Slideshow extends Model {
	 ...
	 */
	function get_photos($organisation_id) {
	...
	function push_up($photo_id, $organisation_id, $order = 'asc') {
		...
		$this->db->query($sql, array($organisation_id, $photo_id, $result->organisation_slideshow_order));
		return true;
	}
	
	function push_down($photo_id, $organisation_id) {
		return push_up($photo_id, $organisation_id, 'desc');
	}
