...
include_once(BASEPATH.'application/helpers/complex_controller.php');
...
class CalendarController extends ComplexController
{
	 ...
	 */
	function __construct($Permission = 'public')
	{
