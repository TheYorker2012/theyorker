  ...
  strtoupper($module);
    ...
    if (!defined("RAPYD_MOD_".strtoupper($module))){
      ...
      switch($module){
        ...
        case "main":
        $rapyd->js[] = RAPYD_DIR. "js/main.php";
        $rapyd->js[] = RAPYD_DIR. "js/main.js";
            
            
        ### tinyMCE (wysiwyg pure javascript textarea replacer | LGPL | version 2 | tinymce.moxiecode.com)
        case "tinymce":
          $rapyd->js[] = RAPYD_DIR. "libraries/tinymce/jscripts/tiny_mce/tiny_mce.js";
          $rapyd->script[] = '
          tinyMCE.init({ 
          /*language: "it",*/
          theme : "advanced", 
          ...
          content_css : "'.RAPYD_DIR.'libraries/tinymce/custom.css"
          });';
          
          $rapyd->script[] = '
          function fileBrowserCallBack(field_name, url, type, win) {
            var connector = "'.RAPYD_DIR.'libraries/tinymce/jscripts/tiny_mce/filemanager/browser.html?Connector=connectors/php/connector.php";
        ...
        case "jscalendar":   
          ...
          $rapyd->js[]  = RAPYD_DIR. "libraries/jscalendar/calendar.js";
          $rapyd->js[]  = RAPYD_DIR. "libraries/jscalendar/calendar-setup.js";          
          $rapyd->css[] = RAPYD_DIR. "libraries/jscalendar/calendar.css";
        ...
        case "colorpicker":   
          $rapyd->js[]  = RAPYD_DIR. "libraries/colorpicker/ColorPicker2.js";
          $rapyd->script[] = ' var cp2 = new ColorPicker(); // DIV style';
          break;

        ### prototype (javascript framework (ajax) | MIT | version 1.4.0 | prototype.conio.net)
        case "prototype":   
          $rapyd->js[]  = RAPYD_DIR. "libraries/prototype/prototype.js";
          break;
