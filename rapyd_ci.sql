...
mySQL dump for rapydsamples

Notes:
- This is a sample table dump for rapyd/samples controller
- Consider to remove "create" and "drop table" instruction if you want to use a custom DB
- see /system/application/config/database.php to manage your connection settings
